...
DATA_FILE_NAME = 'balance.dat'
DATA_URL = 'http://sci2s.ugr.es/keel/dataset/data/classification/balance.zip'  # noqa
logger = logging.getLogger(__name__)


class BalanceSerialize(SerializeSettings):

    def __init__(self, data_path):
        """ See base class """
        super(BalanceSerialize, self).__init__(data_path)
...
def download(url, dst):
    ...
    zip_path = os.path.join(tmp_folder, 'balance.zip')
